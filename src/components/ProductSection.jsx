...
export const ProductSection = (props) => {
  const [mainImageIndex, handlePrevClick, handleNextClick, handleImageClick] =
    useHandlePopupImage();
          ...
          <div className="popup-image">
            <div className="image-container">
              <img
                ...
                src={ImagesRoutes[mainImageIndex].main}
                alt="displayed image"
              />
