      ...
      <div className={"page-links-container" + " " + elementActiveState}>
        <div className="page-links">
          ...
          {navbarSections.map((section, key) => {
            return (
              <a href="#" key={key} onClick={toggleSideBar}>
                {section}
              </a>
            );
          })}
                ...
                <div className="product-container">
                  <div className="article-container">
                    ...
                    <div className="price-infos">
                      ...
                      <p>
                        $125.00 x {props.itemNumber}{" "}
                        <strong>${props.itemNumber * 125}.00</strong>
                      </p>
                    </div>
                    <img
                      src={IconsImagesRoutes.delete}
                      alt="delete icon"
